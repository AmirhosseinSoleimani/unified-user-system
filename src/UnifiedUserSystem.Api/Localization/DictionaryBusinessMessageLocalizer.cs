...
public sealed class DictionaryBusinessMessageLocalizer : IBusinessMessageLocalizer
{
    ...
    private static IReadOnlyDictionary<string, string> EnglishMessages { get; }
        = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [DomainErrorCodes.PhoneNumberAlreadyExists] = "An account with this phone number address already exists.",
    ...
    private static IReadOnlyDictionary<string, string> PersianMessages { get; }
        = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [DomainErrorCodes.EmailAlreadyExists] = "کاربری با این ایمیل وجود دارد",
            [DomainErrorCodes.PhoneNumberAlreadyExists] = "کاربری با این شماره تلفن وجود دارد",
            [DomainErrorCodes.UsernameAlreadyExists] = "کاربری با این نام کاربری وجود دارد",
